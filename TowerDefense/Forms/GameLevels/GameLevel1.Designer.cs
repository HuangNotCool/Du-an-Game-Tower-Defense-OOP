namespace TowerDefense.Forms.GameLevels
{
    partial class GameLevel1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ============================================================
            // 1. NHÓM HỆ THỐNG (Đầu Sidebar - Bên Phải)
            // ============================================================

            // Pause (820, 10)
            this._btnPause.Text = "II";
            this._btnPause.Location = new System.Drawing.Point(820, 10);
            ...
            this._btnSpeed.Location = new System.Drawing.Point(870, 10);
            ...
            // --- FIX MÀU TRẮNG: Đặt màu nền trùng với màu Sidebar ---
            this._flowTowerPanel.BackColor = System.Drawing.Color.FromArgb(45, 45, 55);
            // --------------------------------------------------------
            ...
            // Quan trọng: FlowDirection để xếp nút từ trái qua phải, xuống dòng
            this._flowTowerPanel.FlowDirection = System.Windows.Forms.FlowDirection.LeftToRight;

            // ============================================================
            // 3. SKILL (Dưới danh sách tháp)
            // ============================================================
            ...
            // 
            // GameLevel1 (FORM SETUP - 1000x600)
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;

            // Kích thước chuẩn Sidebar: 800 Map + 200 Menu
